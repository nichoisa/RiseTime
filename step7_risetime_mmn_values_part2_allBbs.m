...
load('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/RTmSERPValsALL.mat');
load('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/RT01ERPValsALL.mat');
load('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/RTin_ERPValsALL.mat');
load('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/RT01_pairedERPValsALL.mat');
...
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perERP/MMN_perERP_ALL.mat','riseTime_MMN1')
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_matchedStandards/MMN_matchedStandards_ALL.mat','riseTime_MMN2')
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perTrial/MMN_perTrial_ALL.mat','riseTime_MMN3')
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perTrial_mS/MMN_perTrial_mS_ALL.mat','riseTime_MMN4')
...
mmn_Exp3=mmnExp{3};
mmn_Exp4=mmnExp{4};
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perERP/MMN_perERP_R_ALL.mat','mmn_Exp1');
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_matchedStandards/MMN_matchedStandards_R_ALL.mat','mmn_Exp2');
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perTrial/MMN_perTrial_R_ALL.mat','mmn_Exp3');
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perTrial_mS/MMN_perTrial_mS_R_ALL.mat','mmn_Exp4');
...
load('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perERP/MMN_perERP_R_ALL.mat');
...
save('/media/aine/5a38de90-ca12-4b4b-bfdc-7240ac05b837/Work_aine/rise time erp/stats/MMN_perERP/MMN_perERP_R_RoIcollapsedALL.mat','mmn_Exp_1R');
...
%%
% matched standards ERP collapsed RoIs
% magnitude values
%windows
windows=find(mmn_Exp_1R(:,2)==2);
Sevens=find(mmn_Exp_1R(windows,7)==7);
...
ThirtiesMMR=find(mmn_Exp_1R(Thirties,9)==2);
sevenMMRThirt=sevenMoWins(ThirtiesMMR);

ThirtiesMMN=find(mmn_Exp_1R(Thirties,9)==1);
sevenMMNThirt=sevenMoWins(ThirtiesMMN);

TwentiesMMR=find(mmn_Exp_1R(Twenties,9)==2);
sevenMMRTwent=sevenMoWins(TwentiesMMR);

TwentiesMMN=find(mmn_Exp_1R(Twenties,9)==1);
sevenMMNTwent=sevenMoWins(TwentiesMMN);

SWTh=mean(mmn_Exp_1R(sevenWinThirt,8))
SWTh_SD=std(mmn_Exp_1R(sevenWinThirt,8))
SWTh_se=SWTh_SD/(sqrt(length(sevenWinThirt)))

SWTw=mean(mmn_Exp_1R(sevenWinTwent,8))
SWTw_SD=std(mmn_Exp_1R(sevenWinTwent,8))
SWTw_se=SWTw_SD/(sqrt(length(sevenWinTwent)))

SWThMMR=mean(mmn_Exp_1R(sevenMMRThirt,8))
SWThMMR_SD=std(mmn_Exp_1R(sevenMMRThirt,8))
SWThMMR_se=SWThMMR_SD/(sqrt(length(sevenMMRThirt)))

SWThMMN=mean(mmn_Exp_1R(sevenMMNThirt,8))
SWThMMN_SD=std(mmn_Exp_1R(sevenMMNThirt,8))
SWThMMN_se=SWThMMN_SD/(sqrt(length(sevenMMNThirt)))

SWTwMMR=mean(mmn_Exp_1R(sevenMMRTwent,8))
SWTwMMR_SD=std(mmn_Exp_1R(sevenMMRTwent,8))
SWTwMMR_se=SWTwMMR_SD/(sqrt(length(sevenMMRTwent)))

SWTwMMN=mean(mmn_Exp_1R(sevenMMNTwent,8))
SWTwMMN_SD=std(mmn_Exp_1R(sevenMMNTwent,8))
SWTwMMN_se=SWTwMMN_SD/(sqrt(length(sevenMMNTwent)))
...
ThirtiesMMR11=find(mmn_Exp_1R(Thirties11,9)==2);
elevenMMRThirt=elevenMoWins(ThirtiesMMR11);

ThirtiesMMN11=find(mmn_Exp_1R(Thirties11,9)==1);
elevenMMNThirt=elevenMoWins(ThirtiesMMN11);

TwentiesMMR11=find(mmn_Exp_1R(Twenties11,9)==2);
elevenMMRTwent=elevenMoWins(TwentiesMMR11);

TwentiesMMN11=find(mmn_Exp_1R(Twenties11,9)==1);
elevenMMNTwent=elevenMoWins(TwentiesMMN11);

EWTh=mean(mmn_Exp_1R(elevenWinThirt,8))
EWTh_SD=std(mmn_Exp_1R(elevenWinThirt,8))
EWTh_se=EWTh_SD/(sqrt(length(elevenWinThirt)))

EWTw=mean(mmn_Exp_1R(elevenWinTwent,8))
EWTw_SD=std(mmn_Exp_1R(elevenWinTwent,8))
EWTw_se=EWTw_SD/(sqrt(length(elevenWinTwent)))

EWThMMR=mean(mmn_Exp_1R(elevenMMRThirt,8))
EWThMMR_SD=std(mmn_Exp_1R(elevenMMRThirt,8))
EWThMMR_se=EWThMMR_SD/(sqrt(length(elevenMMRThirt)))

EWThMMN=mean(mmn_Exp_1R(elevenMMNThirt,8))
EWThMMN_SD=std(mmn_Exp_1R(elevenMMNThirt,8))
EWThMMN_se=EWThMMN_SD/(sqrt(length(elevenMMNThirt)))

EWTwMMR=mean(mmn_Exp_1R(elevenMMRTwent,8))
EWTwMMR_SD=std(mmn_Exp_1R(elevenMMRTwent,8))
EWTwMMR_se=EWTwMMR_SD/(sqrt(length(elevenMMRTwent)))

EWTwMMN=mean(mmn_Exp_1R(elevenMMNTwent,8))
EWTwMMN_SD=std(mmn_Exp_1R(elevenMMNTwent,8))
EWTwMMN_se=EWTwMMN_SD/(sqrt(length(elevenMMNTwent)))
